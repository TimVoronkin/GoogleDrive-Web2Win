...
1.  Navigate to the [`native_host`](./native_host) folder in this repository.
...
3.  Click the <img src="extension/icons/icon48.png" valign="middle" alt="icon" width="24" height="24"> icon.
